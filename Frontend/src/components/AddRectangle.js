...
const AddRectangle = () => {
    ...
    return (
      <div className="add-rectangle-container">
        ...
        <div className="add-rectangle-images-container">
          
          <button className="sroll-btn" onClick={scrollRight}>
          ...
          <div className="add-rectangle-images-cover">
            <div className="add-rectangle-images">
              <div className="add-rectangle-image">
                <img className="image" src="images/back-ground-image.png" alt="image"/>
              </div>
            
              <div className="add-rectangle-image">
                <img className="image" src="images/defaultImage.png" alt="image"/>
              </div>
            </div>
          </div>
          
      
          <button className="sroll-btn" onClick={scrollLeft}>
            <svg width="13" height="32" viewBox="0 0 13 32" fill="none" xmlns="http://www.w3.org/2000/svg">
