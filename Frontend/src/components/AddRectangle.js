    ...
    return (
      ...
      <div className="add-rectangle-container">
        ...
        <div className="add-rectangle-top-part">
          ...
          {ownerShip && ( <div> <button className="light-btn">supprimer</button></div>)}
        </div>
