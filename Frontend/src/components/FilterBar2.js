...
const FilterBar = ()=> {
  ...
  return (
    <div id="filter-bar2">
       <button className="dark-filter-bar-btn"  onClick={setType} >TYPE</button>
       <button className="dark-filter-bar-btn" onClick={setWilaya}>WILAYA</button>
       <button className="dark-filter-bar-btn" onClick={setCommune}>COMMUNE</button>
       <button className="dark-filter-bar-btn" onClick={setPeriode}>PERIODE</button>
